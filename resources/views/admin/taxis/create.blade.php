...
@section('title', 'ADD TAXI ROUTE // RANGO ADMIN')
@section('header', 'NEW TAXI & TRANSFER ROUTE')
        ...
        <div class="flex items-center gap-3 mb-2">
            ...
            <div>
                ...
                <p class="text-xs text-zinc-500 mt-1 font-mono-code">
                    Create private and shared transfer routes for website booking
                </p>
            </div>
        </div>
    </div>

    <form action="{{ route('admin.taxis.store') }}"
          method="POST"
            ...
            <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <select name="zone"
                        ...
                        <option value="phuket">🏝️ Phuket Zone</option>
                        <option value="khaosok">🛶 Khao Sok & Cheow Lan Lake Zone</option>
                        <option value="phangnga">⛰️ Phang Nga & Khao Lak Zone</option>
                        <option value="krabi">🏖️ Krabi & Ao Nang Zone</option>
                    </select>
                </div>
                ...
                <div>
                    ...
                    <input type="text"
                           name="vehicle_type"
                           value="{{ old('vehicle_type', 'VIP Minivan (9-11 Seats)') }}"
                           required
            ...
            <div class="p-6 grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div class="sm:col-span-2 lg:col-span-4">
                    ...
                    <textarea name="price_note"
                              ...
                              class="w-full bg-black/80 text-white border border-zinc-800 rounded-2xl p-4 text-xs focus:border-emerald-500 focus:outline-none transition">{{ old('price_note') }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                ...
                <div>
                    ...
                    <select name="pickup_flexible"
                            class="w-full bg-black/80 text-white border border-zinc-800 rounded-2xl p-4 text-xs focus:border-emerald-500 focus:outline-none transition">
                        <option value="flexible">Flexible Departure (Custom Time)</option>
                ...
                <div class="sm:col-span-2">
                    ...
                    <div class="grid grid-cols-2 sm:grid-cols-4 gap-3">
                        <label class="flex items-center gap-2 bg-black/30 border border-zinc-800 hover:border-emerald-500/30 rounded-xl p-3 cursor-pointer transition">
                            <input type="checkbox" name="features[]" value="air_conditioner" checked class="rounded bg-black border-zinc-700 text-emerald-500">
                            <span class="text-xs text-zinc-300">❄️ Air Conditioning</span>
                        </label>
                        <label class="flex items-center gap-2 bg-black/30 border border-zinc-800 hover:border-emerald-500/30 rounded-xl p-3 cursor-pointer transition">
                            <input type="checkbox" name="features[]" value="wifi" checked class="rounded bg-black border-zinc-700 text-emerald-500">
                            <span class="text-xs text-zinc-300">📶 Free Wi-Fi</span>
                        </label>
                        <label class="flex items-center gap-2 bg-black/30 border border-zinc-800 hover:border-emerald-500/30 rounded-xl p-3 cursor-pointer transition">
                            <input type="checkbox" name="features[]" value="usb" checked class="rounded bg-black border-zinc-700 text-emerald-500">
                            <span class="text-xs text-zinc-300">🔌 USB Charging</span>
                        </label>
                        <label class="flex items-center gap-2 bg-black/30 border border-zinc-800 hover:border-emerald-500/30 rounded-xl p-3 cursor-pointer transition">
                            <input type="checkbox" name="features[]" value="water" checked class="rounded bg-black border-zinc-700 text-emerald-500">
            ...
            <div class="p-6 space-y-5">
                ...
                <div>
                    ...
                    <textarea name="description"
                              ...
                              class="w-full bg-black/80 text-white border border-zinc-800 rounded-2xl p-4 text-xs focus:border-emerald-500 focus:outline-none transition">{{ old('description') }}</textarea>
                </div>
            </div>
        </div>
            ...
            <div class="p-6 grid grid-cols-1 sm:grid-cols-2 gap-5">
                <div>
                    ...
                    <textarea name="cancellation_policy"
                              ...
                              class="w-full bg-black/80 text-white border border-zinc-800 rounded-2xl p-4 text-xs focus:border-emerald-500 focus:outline-none transition">{{ old('cancellation_policy') }}</textarea>
                </div>
                ...
                <div>
                    ...
                    <textarea name="terms"
                              ...
                              class="w-full bg-black/80 text-white border border-zinc-800 rounded-2xl p-4 text-xs focus:border-emerald-500 focus:outline-none transition">{{ old('terms') }}</textarea>
                </div>
            </div>
        </div>
