...
<head>
    ...
    <title>@yield('title', 'COMMAND CENTER // RANGO TOUR ADMIN')</title>
    <!-- Tailwind CSS -->
        ...
        <div>
            ...
            <div class="px-4 py-5 space-y-6">
                ...
                <div>
                    ...
                    <nav class="space-y-1">
                        <a href="{{ route('admin.dashboard') }}" @click="mobileNav = false" 
                           class="flex items-center justify-between px-3.5 py-2.5 sm:py-3 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all duration-200 {{ request()->routeIs('admin.dashboard') ? 'bg-emerald-500 text-neutral-950 font-black shadow-lg shadow-emerald-500/25' : 'text-zinc-400 hover:text-white hover:bg-zinc-900' }}">
                        ...
                        <!-- Live Chat Hub -->
                        <a href="{{ route('admin.chats.index') }}" @click="mobileNav = false" 
                           class="flex items-center justify-between px-3.5 py-2.5 sm:py-3 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all duration-200 {{ request()->routeIs('admin.chats.*') ? 'bg-emerald-500 text-neutral-950 font-black shadow-lg shadow-emerald-500/25' : 'text-zinc-400 hover:text-white hover:bg-zinc-900' }}">
                            <div class="flex items-center gap-3">
                                <span>💬</span> Live Chat Hub
                            </div>
                            <span class="flex items-center gap-1.5 px-2 py-0.5 rounded-full text-[9px] font-mono-code font-bold {{ request()->routeIs('admin.chats.*') ? 'bg-black text-emerald-400' : 'bg-emerald-500/20 text-emerald-300' }}">
                ...
                <div>
                    ...
                    <nav class="space-y-1">
                        <!-- Hero 3-Slides -->
                        <a href="{{ route('admin.banners.index') }}" @click="mobileNav = false" 
                           class="flex items-center justify-between px-3.5 py-2.5 sm:py-3 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all duration-200 {{ request()->routeIs('admin.banners.*') ? 'bg-emerald-500 text-neutral-950 font-black shadow-lg shadow-emerald-500/25' : 'text-zinc-400 hover:text-white hover:bg-zinc-900' }}">
                            <div class="flex items-center gap-3">
                        ...
                        <!-- Tour Packages -->
                        <a href="{{ route('admin.tours.index') }}" @click="mobileNav = false" 
                           class="flex items-center justify-between px-3.5 py-2.5 sm:py-3 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all duration-200 {{ request()->routeIs('admin.tours.*') ? 'bg-emerald-500 text-neutral-950 font-black shadow-lg shadow-emerald-500/25' : 'text-zinc-400 hover:text-white hover:bg-zinc-900' }}">
                            <div class="flex items-center gap-3">
                        ...
                        <!-- 🛶 Welcome to Khao Sok -->
                        <a href="{{ route('admin.resorts.index') }}" @click="mobileNav = false" 
                           class="flex items-center justify-between px-3.5 py-2.5 sm:py-3 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all duration-200 {{ request()->routeIs('admin.resorts.*') ? 'bg-emerald-500 text-neutral-950 font-black shadow-lg shadow-emerald-500/25' : 'text-zinc-400 hover:text-white hover:bg-zinc-900' }}">
                            <div class="flex items-center gap-3">
                                <span>🛶</span> Welcome to Khao Sok
                            </div>
                            <span class="px-1.5 py-0.5 rounded text-[8px] font-mono-code font-bold {{ request()->routeIs('admin.resorts.*') ? 'bg-black text-emerald-400' : 'bg-emerald-500/15 text-emerald-400' }}">
                                10 SLIDES
                            </span>
                        </a>

                        <!-- Best Tours -->
                        <a href="{{ route('admin.destinations.index') }}" @click="mobileNav = false" 
                           class="flex items-center justify-between px-3.5 py-2.5 sm:py-3 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all duration-200 {{ request()->routeIs('admin.destinations.*') ? 'bg-emerald-500 text-neutral-950 font-black shadow-lg shadow-emerald-500/25' : 'text-zinc-400 hover:text-white hover:bg-zinc-900' }}">
                            <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('admin.taxis.index') }}" @click="mobileNav = false" 
                           class="flex items-center justify-between px-3.5 py-2.5 sm:py-3 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all duration-200 {{ request()->routeIs('admin.taxis.*') ? 'bg-emerald-500 text-neutral-950 font-black shadow-lg shadow-emerald-500/25' : 'text-zinc-400 hover:text-white hover:bg-zinc-900' }}">
                            <div class="flex items-center gap-3">
                                <span>🚕</span> Taxi &amp; Transfers
                            </div>
                            <span class="px-1.5 py-0.5 rounded text-[8px] font-mono-code font-bold {{ request()->routeIs('admin.taxis.*') ? 'bg-black text-emerald-400' : 'bg-emerald-500/15 text-emerald-400' }}">
                                4 ZONES
                            </span>
                        </a>

                        <!-- 🗺️ Route Maps Builder -->
                        <a href="{{ route('admin.route-maps.index') }}" @click="mobileNav = false" 
                           class="flex items-center justify-between px-3.5 py-2.5 sm:py-3 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all duration-200 {{ request()->routeIs('admin.route-maps.*') ? 'bg-emerald-500 text-neutral-950 font-black shadow-lg shadow-emerald-500/25' : 'text-zinc-400 hover:text-white hover:bg-zinc-900' }}">
                            ...
                            <span class="px-1.5 py-0.5 rounded text-[8px] font-mono-code font-bold {{ request()->routeIs('admin.route-maps.*') ? 'bg-black text-emerald-400' : 'bg-emerald-500/15 text-emerald-400' }}">
                                GPS PATH
                            </span>
                        </a>

                        <!-- Reviews -->
                        <a href="{{ route('admin.reviews.index') }}" @click="mobileNav = false" 
                           class="flex items-center justify-between px-3.5 py-2.5 sm:py-3 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all duration-200 {{ request()->routeIs('admin.reviews.*') ? 'bg-emerald-500 text-neutral-950 font-black shadow-lg shadow-emerald-500/25' : 'text-zinc-400 hover:text-white hover:bg-zinc-900' }}">
                            <div class="flex items-center gap-3">
                ...
                <div>
                    ...
                    <nav class="space-y-1">
                        <a href="{{ route('admin.settings.index') }}" @click="mobileNav = false" 
                           class="flex items-center justify-between px-3.5 py-2.5 sm:py-3 rounded-2xl text-xs font-bold uppercase tracking-wider transition-all duration-200 {{ request()->routeIs('admin.settings.*') ? 'bg-emerald-500 text-neutral-950 font-black shadow-lg shadow-emerald-500/25' : 'text-zinc-400 hover:text-white hover:bg-zinc-900' }}">
                            <div class="flex items-center gap-3">
                        ...
                        <a href="{{ route('route.map') }}" target="_blank" 
