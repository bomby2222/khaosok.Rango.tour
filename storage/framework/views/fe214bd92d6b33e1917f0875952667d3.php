...
<?php $__env->startSection('title', 'COMMAND MATRIX // RANGO TOUR ADMIN'); ?>
<?php $__env->startSection('header', 'SYSTEM COMMAND MATRIX'); ?>
...
<div class="space-y-6 sm:space-y-10" x-data="dashboardMatrix()">
    ...
    <div class="glass-panel p-5 sm:p-7 rounded-3xl sm:rounded-[2.5rem] border border-emerald-500/20 shadow-2xl relative overflow-hidden flex flex-col lg:flex-row lg:items-center justify-between gap-6">
        ...
        <div class="grid grid-cols-2 sm:flex sm:flex-wrap items-center gap-2.5 z-10">
            ...
            <a href="<?php echo e(route('home')); ?>" target="_blank" class="px-3.5 sm:px-4 py-2.5 sm:py-3 rounded-2xl bg-zinc-900 hover:bg-zinc-800 text-emerald-400 border border-emerald-500/30 text-xs font-bold uppercase tracking-wider transition flex items-center justify-center gap-1">
    ...
    <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-5">
        ...
        <div class="glass-panel p-5 sm:p-6 rounded-3xl border border-emerald-500/15 relative overflow-hidden group hover:border-emerald-500/40 transition">
            ...
            <div class="flex items-baseline justify-between">
                <div>
                    <span class="text-3xl sm:text-5xl font-black text-white font-mono-code"><?php echo e($totalTours); ?></span>
            ...
            <div class="mt-3 pt-3 border-t border-zinc-800/80 flex items-center justify-between text-[11px] font-mono-code">
                <span class="text-emerald-400 font-bold">● <?php echo e($activeTours); ?> On Sale</span>
                <a href="<?php echo e(route('admin.tours.index')); ?>" class="text-zinc-400 hover:text-white">Manage &rarr;</a>
            </div>
        </div>
        ...
        <div class="glass-panel p-5 sm:p-6 rounded-3xl border border-emerald-500/15 relative overflow-hidden group hover:border-teal-500/40 transition">
            <div class="flex items-center justify-between text-zinc-400 mb-2">
                ...
                <span class="px-2 py-0.5 rounded-md bg-teal-500/10 text-teal-300 text-[10px] font-mono-code font-bold"><?php echo e($lastWeekInquiries); ?> This Week</span>
            </div>
            <div class="flex items-baseline justify-between">
                <div>
                    <span class="text-3xl sm:text-5xl font-black text-white font-mono-code"><?php echo e($totalInquiries); ?></span>
            ...
            <div class="mt-3 pt-3 border-t border-zinc-800/80 flex items-center justify-between text-[11px] font-mono-code">
                ...
                <a href="<?php echo e(route('admin.chats.index')); ?>" class="text-emerald-400 hover:text-emerald-300 font-bold">Inbox &rarr;</a>
            </div>
        </div>
        ...
        <div class="glass-panel p-5 sm:p-6 rounded-3xl border border-emerald-500/15 relative overflow-hidden group hover:border-amber-500/40 transition">
            <div class="flex items-center justify-between text-zinc-400 mb-2">
                ...
                <span class="px-2 py-0.5 rounded-md bg-amber-500/10 text-amber-300 text-[10px] font-mono-code font-bold"><?php echo e($fiveStarPercent); ?>% 5★</span>
            </div>
            <div class="flex items-baseline justify-between">
                <div>
                    <span class="text-3xl sm:text-5xl font-black text-white font-mono-code"><?php echo e($avgRating); ?></span>
                    <span class="text-xs text-amber-400 ml-1 font-bold">/ 5.0 ★</span>
                </div>
                <div class="text-2xl sm:text-3xl text-amber-400">⭐</div>
            </div>
            <div class="mt-3 pt-3 border-t border-zinc-800/80 flex items-center justify-between text-[11px] font-mono-code">
                <span class="text-zinc-400"><?php echo e($totalReviews); ?> Reviews</span>
                <a href="<?php echo e(route('admin.reviews.index')); ?>" class="text-amber-400 hover:underline">Moderate &rarr;</a>
            </div>
        </div>
        ...
        <div class="glass-panel p-5 sm:p-6 rounded-3xl border border-emerald-500/15 relative overflow-hidden group hover:border-emerald-400/40 transition">
            ...
            <div class="flex items-baseline justify-between">
                <div>
                    <span class="text-3xl sm:text-5xl font-black text-white font-mono-code"><?php echo e($totalSeatsAvailable); ?></span>
                    <span class="text-xs text-zinc-500 ml-1 font-mono-code">Seats</span>
                </div>
                <div class="text-2xl sm:text-3xl text-emerald-400">🏝️</div>
            </div>
            <div class="mt-3 pt-3 border-t border-zinc-800/80 flex items-center justify-between text-[11px] font-mono-code">
                <span class="text-emerald-400"><?php echo e($totalResorts); ?> Resorts Matrix</span>
        ...
        <div class="lg:col-span-4 glass-panel p-5 sm:p-8 rounded-3xl sm:rounded-[2.5rem] border border-emerald-500/15 shadow-2xl flex flex-col justify-between space-y-4 sm:space-y-6">
            ...
            <div class="relative w-full h-36 sm:h-44 flex items-center justify-center">
                ...
                <div class="absolute inset-0 flex flex-col items-center justify-center pointer-events-none">
                    <span class="text-xl sm:text-2xl font-black text-white"><?php echo e(max($totalInquiries, 1)); ?></span>
            ...
            <div class="space-y-2.5">
                <div>
                    <div class="flex justify-between text-[11px] font-mono-code mb-1">
                        ...
                        <span class="font-bold text-emerald-400"><?php echo e($totalInquiries); ?></span>
                    </div>
    ...
    <div class="glass-panel p-5 sm:p-8 rounded-3xl sm:rounded-[2.5rem] border border-emerald-500/15 shadow-2xl">
        <div class="flex flex-col sm:flex-row sm:items-center justify-between gap-2 mb-4 sm:mb-6 pb-3 border-b border-zinc-800">
            ...
            <a href="<?php echo e(route('admin.resorts.index')); ?>" class="text-xs font-mono-code text-emerald-400 hover:underline font-bold">
                Manage Resorts &rarr;
            </a>
        </div>

        <?php if($resorts->isEmpty()): ?>
            <div class="text-center py-8 border border-dashed border-zinc-800 rounded-2xl">
                ...
                <a href="<?php echo e(route('admin.resorts.create')); ?>" class="text-xs font-bold text-emerald-400 hover:underline mt-1 inline-block">+ Add First Resort</a>
            </div>
        <?php else: ?>
                ...
                <?php $__currentLoopData = $resorts; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $resort): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <div class="bg-black/60 p-3 rounded-2xl border border-zinc-800 text-center group">
                        <div class="w-10 h-10 mx-auto rounded-xl overflow-hidden mb-1.5 border border-zinc-700 bg-neutral-950">
                            <img src="<?php echo e(asset('storage/' . $resort->image)); ?>" alt="<?php echo e($resort->name); ?>" class="w-full h-full object-cover group-hover:scale-110 transition">
                        </div>
                        <h5 class="text-[10px] sm:text-[11px] font-bold text-white truncate"><?php echo e($resort->name); ?></h5>
                        <span class="mt-1 inline-block px-1.5 py-0.5 rounded text-[8px] sm:text-[9px] font-mono-code font-bold text-emerald-400 bg-emerald-950/60 border border-emerald-800/80">
                            <?php echo e($resort->subtitle ?? 'Resort'); ?>
    ...
    <div class="glass-panel p-5 sm:p-8 rounded-3xl sm:rounded-[2.5rem] border border-emerald-500/15 shadow-2xl space-y-4 sm:space-y-6">
        ...
        <?php if($allTours->isEmpty()): ?>
            <div class="text-center py-12 border border-dashed border-zinc-800 rounded-3xl">
                ...
                <a href="<?php echo e(route('admin.tours.create')); ?>" class="text-xs font-bold text-emerald-400 hover:underline mt-1 inline-block">+ Create Tour Package</a>
            </div>
        <?php else: ?>
                ...
                <table class="w-full text-left text-xs text-zinc-300 min-w-[600px]">
                    ...
                    <tbody class="divide-y divide-zinc-800/60 font-sans">
                        <?php $__currentLoopData = $allTours; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tour): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr class="hover:bg-zinc-900/50 transition" x-show="matchesSearch('<?php echo e(strtolower($tour->title . ' ' . $tour->location)); ?>')">
                                <td class="p-3.5">
                                    <img src="<?php echo e(asset('storage/' . $tour->cover_image)); ?>" class="w-14 h-10 sm:w-16 sm:h-12 rounded-xl object-cover border border-zinc-800 bg-zinc-950">
                                </td>
                                <td class="p-3.5">
                                    <span class="font-bold text-white text-xs sm:text-sm block"><?php echo e($tour->title); ?></span>
                                    <span class="text-[10px] text-zinc-500">📍 <?php echo e($tour->location); ?></span>
                                </td>
                                ...
                                <td class="p-3.5 font-mono-code text-zinc-400">
                                    <?php echo e($tour->duration_days); ?>D <?php echo e($tour->duration_nights); ?>N
                                </td>
                                <td class="p-3.5">
                                    <?php if($tour->status): ?>
                                ...
                                <td class="p-3.5 text-right space-x-2.5 font-mono-code text-xs">
                                    <a href="<?php echo e(route('tours.show', $tour->slug)); ?>" target="_blank" class="text-zinc-400 hover:text-emerald-400">View ↗</a>
                                    <form action="<?php echo e(route('admin.tours.destroy', $tour->id)); ?>" method="POST" class="inline" onsubmit="return confirm('Delete this tour?')">
                                        <?php echo csrf_field(); ?>
    ...
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-6 sm:gap-8 items-start">
        <div class="lg:col-span-8 glass-panel p-5 sm:p-8 rounded-3xl sm:rounded-[2.5rem] border border-emerald-500/15 shadow-2xl space-y-4">
            <div class="flex items-center justify-between pb-3 border-b border-zinc-800">
                ...
                <a href="<?php echo e(route('admin.reviews.index')); ?>" class="text-xs font-mono-code text-emerald-400 hover:underline">View All &rarr;</a>
            </div>
                    ...
                    <?php $__currentLoopData = $recentReviews; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $rev): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        <div class="bg-black/60 p-3.5 sm:p-4 rounded-2xl border border-zinc-800 flex flex-col sm:flex-row sm:items-start justify-between gap-3">
                            <div class="space-y-1.5 flex-grow">
                                <div class="flex flex-wrap items-center gap-2">
                                    <span class="font-bold text-white text-xs"><?php echo e($rev->name); ?></span>
                                    <span class="text-amber-400 text-xs"><?php echo e(str_repeat('★', $rev->rating)); ?></span>
                                    <span class="text-[10px] font-mono-code text-zinc-500">• <?php echo e($rev->created_at->diffForHumans()); ?></span>
                                </div>
                                <p class="text-xs text-zinc-300 line-clamp-2">"<?php echo e($rev->comment); ?>"</p>
                            </div>
                            <form action="<?php echo e(route('admin.reviews.destroy', $rev->id)); ?>" method="POST" onsubmit="return confirm('Delete review?')">
                                <?php echo csrf_field(); ?>
                                <?php echo method_field('DELETE'); ?>
    ...
    <div x-show="openQuickTourModal" x-cloak class="fixed inset-0 z-50 flex items-center justify-center bg-black/85 backdrop-blur-md p-4">
        <div @click.away="openQuickTourModal = false" class="glass-panel border border-emerald-500/30 rounded-3xl max-w-lg w-full p-5 sm:p-8 shadow-2xl relative max-h-[90vh] overflow-y-auto">
            ...
            <form action="<?php echo e(route('admin.tours.store')); ?>" method="POST" enctype="multipart/form-data" class="space-y-3.5 text-xs font-mono-code">
                <?php echo csrf_field(); ?>
                <div>
...
<script>
    function dashboardMatrix() {
        return {
            ...
            chartData7D: {
                labels: <?php echo json_encode($chart7DaysLabels, 15, 512) ?>,
                data: <?php echo json_encode($chart7DaysData, 15, 512) ?>
            },
            chartData30D: {
                labels: <?php echo json_encode($chart30DaysLabels, 15, 512) ?>,
                data: <?php echo json_encode($chart30DaysData, 15, 512) ?>
            },
            chartData1Y: {
                labels: <?php echo json_encode($chartYearLabels, 15, 512) ?>,
                data: <?php echo json_encode($chartYearData, 15, 512) ?>
            },
            ...
            initChannelDonut() {
                ...
                new Chart(ctx, {
                    ...
                    data: {
                        ...
                        datasets: [{
                            data: [<?php echo e(max($totalInquiries, 1)); ?>, 1],
...
<?php echo $__env->make('layouts.admin', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\rango-tour\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>